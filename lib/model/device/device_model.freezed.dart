...
abstract class $DeviceModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String token, String osVersion, String appVersion});
}
...
class _$DeviceModelImpl implements _DeviceModel {
  ...
  @override
  String toString() {
    return 'DeviceModel(id: $id, token: $token, osVersion: $osVersion, appVersion: $appVersion)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, token, osVersion, appVersion);
...
abstract class _DeviceModel implements DeviceModel {
  const factory _DeviceModel(
      ...
      required final String appVersion}) = _$DeviceModelImpl;
