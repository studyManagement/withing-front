              ...
              child: Column(
                ...
                children: [
                  ...
                  Consumer<BoardViewModel>(
                      builder: (context, viewModel, _) => PostCategorySelector(
                            postCategories: viewModel.postCategories,
                            selectedIndex: viewModel.selectedPostCategoryIndex,
                          )),
                  const SizedBox(height: 20),
                  const Gray100Divider(),
                  BoardTextField(
                    onChanged: (value) {
                      viewModel.isValidInput(BoardInputType.boardTitle, value);
                    },
                    onEditingCompleted: () {
                      if (viewModel.isValid) {
                        viewModel.createPost(context).then((_) => {
